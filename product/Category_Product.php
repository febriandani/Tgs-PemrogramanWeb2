    ...
    <!-- <ul class="list-unstyled CTAs">
        ...
        <div id="content">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" placeholder="Masukkan Kode" maxlength="3" name="p_kode" required="required">
			</div>
			<div class="form-group">
				<label>Kategori Nama Produk</label>
				<input type="text" class="form-control" placeholder="Masukkan Nama" maxlength="20" name="p_nama" required="required">
			</div>
